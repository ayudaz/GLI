...
public class PSolitaire extends JPanel {
	...
	public PSolitaire(CSolitaire controle) {
		...
		Dimension d = new Dimension(PCarte.largeur * 2 + 30 + 15 * 24,
				PCarte.hauteur);
	...
	public void setSabot(PSabot sabot, TasDeCartesColorees[] pilesColorees) {
		...
		sabot.setSabotMouseListener(new SabotMouseListener(sabot.getControle(),
				pilesColorees));
	}
	...
	public void addColonne(PColonne pileAlternee,
		...
		pileAlternee.setColonneListener(new ColonneMouseListener(pileAlternee
				.getControle(), pilesColorees));
	}
	...
	public void setClicDroitMouseListener(CSabot sabot, Colonne[] colonnes,
			TasDeCartesColorees[] tasDeCartesColorees) {
		this.addMouseListener(new SolitaireClicDroitMouseListener(sabot,
				colonnes, tasDeCartesColorees));
	}
